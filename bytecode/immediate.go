...
func FetchU8(data []uint8, pc int) (newpc int, value uint8, err error) {
	if pc >= len(data) || pc < 0 {
...
func FetchU16(data []uint8, pc int) (newpc int, value uint16, err error) {
...
func FetchU24(data []uint8, pc int) (newpc int, value uint32, err error) {
...
func FetchU32(data []uint8, pc int) (newpc int, value uint32, err error) {
...
func FetchU40(data []uint8, pc int) (newpc int, value uint64, err error) {
...
func FetchU48(data []uint8, pc int) (newpc int, value uint64, err error) {
...
func FetchU56(data []uint8, pc int) (newpc int, value uint64, err error) {
...
func FetchU64(data []uint8, pc int) (newpc int, value uint64, err error) {
...
func FetchN(data []uint8, pc, count int) (newpc int, value uint64, err error) {
	if count < 0 {
